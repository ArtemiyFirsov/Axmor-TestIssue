...
using Axmor_TestIssue.Services;
using Axmor_TestIssue.SqlServer;
...
namespace Axmor_TestIssue.WebbApp.App_Start
{
    ...
    public class UnityConfig
    {
        ...
        {
            container.RegisterType(typeof(IItemsService), typeof(ItemsService));
            container.RegisterType(typeof(IRepo<>), typeof(Repo<>));
            container.RegisterType(typeof(ICrudService<>), typeof(CrudService<>));
            container.RegisterType(typeof(ICacheProvider), typeof(MemcachedCacheClient));
